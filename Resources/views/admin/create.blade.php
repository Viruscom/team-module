            ...
            <div class="col-sm-12 col-xs-12">
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        @include('admin.partials.on_create.form_fields.select', ['fieldName' => 'division_id', 'label' => trans('team::admin.team_division.division'), 'models' => $divisions, 'required' => false, 'labelClass' => 'select-label-fix', 'class' => 'select-fix m-b-10', 'withPleaseSelect' => true])
