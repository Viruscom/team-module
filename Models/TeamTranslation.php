...
class TeamTranslation extends Model implements CommonModelTranslationInterfaces
{
    use StorageActions;

    protected $table    = "team_translation";
    protected $fillable = ['locale', 'team_id', 'title', 'url', 'announce', 'description', 'visible'];
